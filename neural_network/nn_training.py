...
def AI_loop():
    ...
    bias = 1
    data = [convert_angle(heading), vel, reload_time, N, S, W, E, NW, NE, SW, SE, enemy_dist,
    ...
    elif ai.selfAlive() == 0 and weights_updated is False and row_count == 52:
